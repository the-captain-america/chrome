...
const colFlex = (count = maxGridColumnCount, enableFlex = false) => {
  return css`
...
const colMediaQuery = (media, count, offset, enableFlex = false) => {
  ...
  return css`
    @media ${mediaText} {
      ${count && colFlex(count, enableFlex)};
...
const Col = styled.div.attrs({ className: 'Col' })`
  ...
  ${(props) =>
    ...
    colMediaQuery(mediaOrder[0], props.xxs, props.offsetXxs, props.enableFlex)};
  ${(props) =>
    (props.xs || typeof props.offsetXs === 'number') &&
    colMediaQuery(mediaOrder[1], props.xs, props.offsetXs, props.enableFlex)};
  ${(props) =>
    (props.sm || typeof props.offsetSm === 'number') &&
    colMediaQuery(mediaOrder[2], props.sm, props.offsetSm, props.enableFlex)};
  ${(props) =>
    (props.md || typeof props.offsetMd === 'number') &&
    colMediaQuery(mediaOrder[3], props.md, props.offsetMd, props.enableFlex)};
  ${(props) =>
    (props.lg || typeof props.offsetLg === 'number') &&
    colMediaQuery(mediaOrder[4], props.lg, props.offsetLg, props.enableFlex)};
  ${(props) =>
    (props.xl || typeof props.offsetXl === 'number') &&
    colMediaQuery(mediaOrder[5], props.xl, props.offsetXl, props.enableFlex)};
  ${(props) =>
    (props.xxl || typeof props.offsetXxl === 'number') &&
    colMediaQuery(mediaOrder[6], props.xxl, props.offsetXxl, props.enableFlex)};
`
