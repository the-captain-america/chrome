...
//     copyToClipboard()
//     callback({ action: 'UPDATE', name, value: item })
//   }
...
import { Container, ColorSwatch, IconContainer } from './ColorPicker.styled'
import { Icon } from '@common/Icon'
import { Line } from '@common/Line'

const ColorPicker = ({ options = [], value, name, callback, mt }) => {
